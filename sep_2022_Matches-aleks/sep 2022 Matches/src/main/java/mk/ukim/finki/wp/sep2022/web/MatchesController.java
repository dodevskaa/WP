...
public class MatchesController {
     ...
     * @return The view "form.html".
     */
    @GetMapping(path = "/matches/{id}/edit")
    public String showEdit(@PathVariable Long id, Model model) {
        model.addAttribute("matches", this.matchService.findById(id));
        model.addAttribute("types",MatchType.values());
        model.addAttribute("locations",matchLocationService.listAll());
     ...
     * @return The view "list.html".
     */
    @PostMapping(path = "/matches/{id}/delete")
     ...
     * @return The view "list.html".
     */
    @PostMapping(path = "/matches/{id}/follow")
