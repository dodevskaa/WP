...
public class TaskController {
    ...
    public String showEdit(@PathVariable Long id, Model model)
    {
        model.addAttribute("assignees",userService.listAll());
        model.addAttribute("categories", TaskCategory.values());
        model.addAttribute("tasks",service.findById(id));
    ...
    public String create(@RequestParam String title,@RequestParam String description,@RequestParam TaskCategory category,@RequestParam List<Long> assignees,@RequestParam String dueDate)
    {
    ...
    public String update(@PathVariable Long id,@RequestParam String title,@RequestParam String description,@RequestParam TaskCategory category,@RequestParam List<Long> assignees) {
     ...
     * @return The view "list.html".
     */
    @PostMapping(path = "/tasks/{id}/delete")
     ...
     * @return The view "list.html".
     */
    @PostMapping(path = "/tasks/{id}/mark_done")
